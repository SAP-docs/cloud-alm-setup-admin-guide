<!-- loio14001e1b12034c07ac97b81f5b44bb84 -->

# SAP NetWeaver Application Server for ABAP \(7.40 and higher\), including SAP BW/4HANA
...
Currently, SAP NetWeaver Application Server for ABAP \(7.40 and higher\) supports the following monitoring applications:

-   [Integration and Exception Monitoring](https://help.sap.com/docs/cloud-alm/applicationhelp/integration-exception-monitoring)

    Specific setup information for Integration & Exception Monitoring: [SAP NetWeaver Application Server for ABAP \(higher than 7.40\)](https://support.sap.com/en/alm/sap-cloud-alm/operations/expert-portal/integration-monitoring/calm-nw-abap.html).
...
The following video demonstrates the setup for application monitoring for SAP NetWeaver Application Server for ABAP \(7.40 and higher\), including SAP BW/4HANA. A textual step-by-step description of all setup steps is provided after the video on this site.





<a name="loio14001e1b12034c07ac97b81f5b44bb84__section_f4s_wwr_bhc"/>
...
Specific prerequisites for the setup of Integration & Exception Monitoring under [SAP NetWeaver Application Server for ABAP \(higher than 7.40\)](https://support.sap.com/en/alm/sap-cloud-alm/operations/expert-portal/integration-monitoring/calm-nw-abap.html).



<a name="loio14001e1b12034c07ac97b81f5b44bb84__section_rn1_yd5_bhc"/>
...
<a name="loio14001e1b12034c07ac97b81f5b44bb84__section_j4f_gkz_3hc"/>
...
After the successful setup that's described in the previous section, the SAP NetWeaver Application Server for ABAP \(7.40 and higher\) system appears as a registered service in the *Landscape Management* app of SAP Cloud ALM.

> ### Tip:  
> The data collection for the selected use-cases is automatically active now.
> 
> We recommend using the standard collection interval. Only for specific requirements, change the *Collection interval* for the different use cases. *Business Process Monitoring* uses a separate scheduler, therefore this specific value cannot be changed.
...
<a name="loio14001e1b12034c07ac97b81f5b44bb84__section_ak4_zd5_bhc"/>
...
<a name="loio14001e1b12034c07ac97b81f5b44bb84__section_sqt_hps_bhc"/>

## Troubleshooting

To troubleshoot any issues with the setup or the data collection for SAP BTP, ABAP environment, also refer to [Troubleshooting for ABAP Systems](https://support.sap.com/en/alm/sap-cloud-alm/operations/expert-portal/calm-op-troubleshooting/calm-troubleshooting-abap.html).

-   **[Additional SAP HANA Database Health Monitoring Metrics for SAP S/4HANA](additional-sap-hana-database-health-monitoring-metrics-for-sap-s-4hana-03b2e1f.md "Learn how to get additional metrics for the health monitoring metrics of SAP
		HANA.")**  
