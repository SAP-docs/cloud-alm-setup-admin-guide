<!-- loio782a5636ae874e53830d5198911bf794 -->
...
-   **Yes**: The action is available to users with this role.

-   **No**: The action is not available to users with this role.


> ### Tip:  
> To find out which apps are available to each role, search for **Access the app** in the **Action** column.



<a name="loio782a5636ae874e53830d5198911bf794__section_tll_s4c_y2c"/>
...
Create, edit, and delete custom roles, system groups, and workstreams
...
Create, edit, archive, and restore deployment plans
...
Generate role assignment requests by adding users to a project
...
Set Up Tricentis Test Automation for SAP
...
Start the Tricentis provisioning \*
...
Create project tasks, user stories, quality gates, and sub-tasks
...
Edit and delete roadmap tasks, project tasks, user stories, sub-tasks, quality gates, requirements, and defects
...
Create, edit, and delete quality gates
...
Request SAP assessment service
...
View process and custom process content
...
Copy solution process flow diagrams
...
View user stories / requirements / tasks
...
Create, assign, and unassign user stories / requirements / tasks
...
Create, assign, and unassign documents
...
View test content and test cases
...
Create, assign, and unassign test cases
...
Assign or unassign process hierarchy nodes
...
Assign or unassign library elements
...
Create, edit, and delete custom process content
...
Manage custom solution processes
...
View solution activity process hierarchy node relations
...
View all other solution activity relations
...
Assign solution activities to process hierarchy nodes
...
Create requirements, user stories, project tasks, and features
...
Delete and remove test cases without test results
...
Delete and remove test cases with test results
...
Assign test cases to test plans
...
Unassign test cases without test results
...
Unassign test cases with test results
...
Delete test plans without test results
...
Delete test plans with test results
...
View test results and executed test runs
...
Create user stories and project tasks
...
Assign and unassign transports
...
Create, edit, and delete analyses
...
Create, assign, and unassign follow-ups
...
SAP Readiness Check Integration
...
Centrally create and edit tags
...
View business service overview and details
...
Add and delete services and systems
...
Edit and delete SAP corporate group S-user
...
\* also requires an S-user with `Edit Cloud Data` role



<a name="loio782a5636ae874e53830d5198911bf794__section_p4w_f5s_z2c"/>
...
Create and edit process hierarchy nodes
...
Create and edit custom process content
...
<a name="loio782a5636ae874e53830d5198911bf794__section_isc_f5s_z2c"/>

## Change & Deployment Management

For Change & Deployment Management, we recommend combining role collections to enable relevant authorizations for your tasks. For more information, see [Role Collection Recommendations](https://help.sap.com/docs/cloud-alm/applicationhelp/role-collection-recommendations).
...
<a name="loio782a5636ae874e53830d5198911bf794__section_wpg_q5s_z2c"/>
