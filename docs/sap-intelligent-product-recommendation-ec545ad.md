...
-   [Integration & Exception Monitoring](https://help.sap.com/docs/cloud-alm/applicationhelp/integration-exception-monitoring)
    ...
    Specific setup information for Integration & Exception Monitoring: [SAP Intelligent Product Recommendation](https://support.sap.com/en/alm/sap-cloud-alm/operations/expert-portal/integration-monitoring/calm-irp.html).
...
Specific prerequisites for the setup of Integration & Exception Monitoring under [SAP Intelligent Product Recommendation](https://support.sap.com/en/alm/sap-cloud-alm/operations/expert-portal/integration-monitoring/calm-irp.html).
