...
As a first step, retrieve *SAP Cloud ALM API* credentials as described in [Enabling SAP Cloud ALM API in Cloud Foundry](enabling-sap-cloud-alm-api-in-cloud-foundry-7d4c180.md).
