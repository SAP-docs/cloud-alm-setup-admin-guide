<!-- loioe1443054d98d463cadbd8dc6c1cb92bc -->
...
<a name="loioe1443054d98d463cadbd8dc6c1cb92bc__section_i2g_yh5_bhc"/>

## Prerequisites

This setup is required if **any** of the following specifics applies:
...
4.  In the *Outbound Services* section, enter the path and service URL for each of the outbound services:
    1.  *SAP Cloud ALM - BPMon Configuration*:
        ...
        *Scheduler*: Enter a slash \(/\) in the *Path* field and choose enter. This triggers the propagation of the following fields.
    ...
    2.  *SAP Cloud ALM - BPMon Data*
        ...
        *Job Execution Details*: Schedule the job to run every minute. The job is activated after saving.
...
<a name="loioe1443054d98d463cadbd8dc6c1cb92bc__section_mzk_yn5_bhc"/>
