<!-- loio4697120bb5934e84a395d4708a2b3f32 -->
...
Currently, SAP Variant Configuration and Pricing supports the following monitoring applications:

-   [Integration and Exception Monitoring](https://help.sap.com/docs/cloud-alm/applicationhelp/integration-exception-monitoring)

    Specific setup information for Integration & Exception Monitoring: [SAP Variant Configuration and Pricing](https://support.sap.com/en/alm/sap-cloud-alm/operations/expert-portal/integration-monitoring/calm-vcp.html).
...
Specific prerequisites for the setup of Integration & Exception Monitoring under [SAP Variant Configuration and Pricing](https://support.sap.com/en/alm/sap-cloud-alm/operations/expert-portal/integration-monitoring/calm-vcp.html).
