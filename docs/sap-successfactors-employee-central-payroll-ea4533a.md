<!-- loioea4533a15f0d486ba023db537f76dee4 -->
...
Currently, SAP SuccessFactors Employee Central Payroll supports the following applications:

-   [Integration and Exception Monitoring](https://help.sap.com/docs/cloud-alm/applicationhelp/integration-exception-monitoring)

    Specific setup information for Integration & Exception Monitoring: [SAP SuccessFactors Employee Central Payroll](https://support.sap.com/en/alm/sap-cloud-alm/operations/expert-portal/integration-monitoring/calm-ecp.html).
...
-   [Features](https://help.sap.com/docs/cloud-alm/applicationhelp/features)

    Specific setup information for transport management: [Transport Management Setup for Employee Central Payroll](transport-management-setup-for-employee-central-payroll-bd23fb3.md)




<a name="loioea4533a15f0d486ba023db537f76dee4__section_e41_jy4_chc"/>
...
Specific prerequisites for the setup of Integration & Exception Monitoring under [SAP SuccessFactors Employee Central Payroll](https://support.sap.com/en/alm/sap-cloud-alm/operations/expert-portal/integration-monitoring/calm-ecp.html).



<a name="loioea4533a15f0d486ba023db537f76dee4__section_ex4_xy4_chc"/>
...
<a name="loioea4533a15f0d486ba023db537f76dee4__section_j4f_gkz_3hc"/>
...
<a name="loioea4533a15f0d486ba023db537f76dee4__section_wxw_y1p_chc"/>
...
<a name="loioea4533a15f0d486ba023db537f76dee4__section_u3p_jbp_chc"/>

## Troubleshooting

To troubleshoot any issues with the setup or the data collection, refer to [Troubleshooting for ABAP Systems](troubleshooting-for-abap-systems-cb82fd2.md).

-   **[Transport Management Setup for Employee Central Payroll](transport-management-setup-for-employee-central-payroll-bd23fb3.md "How to enable SAP Cloud ALM as the transport management tool for your Employee Central
    Payroll (ECP) landscape. ")**  
How to enable SAP Cloud ALM as the transport management tool for your Employee Central Payroll \(ECP\) landscape.
-   **[Additional SAP HANA Database Health Monitoring Metrics for SAP S/4HANA](additional-sap-hana-database-health-monitoring-metrics-for-sap-s-4hana-338a806.md "Learn how to get additional metrics for the health monitoring metrics of SAP
		HANA.")**  
