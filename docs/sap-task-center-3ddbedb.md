<!-- loio3ddbedb6b10742d4a45542f6d51d2f73 -->

# SAP Task Center

This page explains how to connect SAP Task Center to SAP Cloud ALM to enable monitoring.

Currently, SAP Task Center supports the following monitoring applications:

-   [Integration and Exception Monitoring](https://help.sap.com/docs/cloud-alm/applicationhelp/integration-exception-monitoring)

    Specific setup information for Integration & Exception Monitoring: [SAP Task Center](https://support.sap.com/en/alm/sap-cloud-alm/operations/expert-portal/integration-monitoring/calm-stc.html).
...
Specific prerequisites for the setup of Integration & Exception Monitoring under [SAP Task Center](https://support.sap.com/en/alm/sap-cloud-alm/operations/expert-portal/integration-monitoring/calm-stc.html).
