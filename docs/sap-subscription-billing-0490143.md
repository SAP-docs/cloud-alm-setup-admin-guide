...
-   [Integration & Exception Monitoring](https://help.sap.com/docs/cloud-alm/applicationhelp/integration-exception-monitoring)
    ...
    Specific setup information for Integration & Exception Monitoring: [SAP Subscription Billing](https://support.sap.com/en/alm/sap-cloud-alm/operations/expert-portal/integration-monitoring/calm-im-sub-bill.html).
...
Specific prerequisites for the setup of Integration & Exception Monitoring under [SAP Subscription Billing](https://support.sap.com/en/alm/sap-cloud-alm/operations/expert-portal/integration-monitoring/calm-im-sub-bill.html).
